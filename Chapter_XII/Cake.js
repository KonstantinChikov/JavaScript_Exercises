// Ex. VI --> Поканени сте на 30-ти рожден ден, на който рожденикът черпи с огромна торта. 
...
function Cake(input){
    ...
    while(command !== "STOP"){
        ...
        if(pieces > total){
            console.log(`No more cake left! You need ${pieces - total} pieces more.`);
            break;
        }
    ...
    if(pieces <= total){
        console.log(`${total - pieces} pieces are left.`);
    }
